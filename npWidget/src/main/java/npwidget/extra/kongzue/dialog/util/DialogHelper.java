package npwidget.extra.kongzue.dialog.util;
...
import npwidget.extra.kongzue.dialog.v3.BottomMenu;
import npwidget.extra.kongzue.dialog.v3.CustomDialog;
import npwidget.extra.kongzue.dialog.v3.FullScreenDialog;
import npwidget.extra.kongzue.dialog.v3.ShareDialog;
...
public class DialogHelper extends DialogFragment {
    ...
    private void findMyParentAndBindView(View rootView) {
        ...
        BaseDialog.newContext = new WeakReference<>((FragmentActivity) getContext());
        for (BaseDialog baseDialog : cache) {
            baseDialog.context = new WeakReference<>((FragmentActivity) getContext());
