...
import npwidget.extra.kongzue.dialog.util.view.ProgressView;
...
public class TipDialog extends BaseDialog {
    ...
    public static TipDialog build(FragmentActivity context) {
    ...
    public static TipDialog showWait(FragmentActivity context, String message) {
        synchronized (TipDialog.class) {
    ...
    public static TipDialog showWait(FragmentActivity context, int messageResId) {
        synchronized (TipDialog.class) {
            TipDialog waitDialog = build(context);
    ...
    public static TipDialog show(FragmentActivity context, String message, TYPE type) {
        synchronized (TipDialog.class) {
            TipDialog waitDialog = build(context);
            ...
            if (waitDialog == null) {
                ...
                waitDialogTemp.setCancelable(true);
                waitDialogTemp.setMessage(message);
...
//                waitDialog.autoDismiss();
    ...
    public static TipDialog show(FragmentActivity context, int messageResId, TYPE type) {
        return show(context, context.getString(messageResId), type);
    }
    
    public static TipDialog show(FragmentActivity context, String message, int icoResId) {
        synchronized (TipDialog.class) {
            TipDialog waitDialog = build(context);
    ...
    public static TipDialog show(FragmentActivity context, int messageResId, int icoResId) {
