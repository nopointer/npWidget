...
import npwidget.extra.kongzue.dialog.util.view.IOSItemImageView;
import npwidget.extra.kongzue.dialog.util.view.TableLayout;
...
public class ShareDialog extends BaseDialog {
    ...
    public static ShareDialog build(@NonNull FragmentActivity context) {
    ...
    public static ShareDialog show(@NonNull FragmentActivity context, List<Item> itemList, OnItemClickListener onItemClickListener) {
