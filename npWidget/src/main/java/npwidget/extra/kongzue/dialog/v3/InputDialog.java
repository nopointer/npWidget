...
import npwidget.extra.kongzue.dialog.util.InputInfo;
...
public class InputDialog extends MessageDialog {
    ...
    public static InputDialog build(@NonNull FragmentActivity context) {
    ...
    public static InputDialog show(@NonNull FragmentActivity context, String title, String message) {
        synchronized (InputDialog.class) {
    ...
    public static InputDialog show(@NonNull FragmentActivity context, int titleResId, int messageResId) {
        synchronized (InputDialog.class) {
    ...
    public static InputDialog show(@NonNull FragmentActivity context, String title, String message, String okButton) {
        synchronized (InputDialog.class) {
    ...
    public static InputDialog show(@NonNull FragmentActivity context, int titleResId, int messageResId, int okButtonResId) {
        synchronized (InputDialog.class) {
            InputDialog inputDialog = show(context,
                    context.getString(titleResId),
                    context.getString(messageResId),
    ...
    public static InputDialog show(@NonNull FragmentActivity context, String title, String message, String okButton, String cancelButton) {
        synchronized (InputDialog.class) {
    ...
    public static InputDialog show(@NonNull FragmentActivity context, int titleResId, int messageResId, int okButtonResId, int cancelButtonResId) {
        synchronized (InputDialog.class) {
    ...
    public static InputDialog show(@NonNull FragmentActivity context, String title, String message, String okButton, String cancelButton, String otherButton) {
        synchronized (InputDialog.class) {
    ...
    public static InputDialog show(@NonNull FragmentActivity context, int titleResId, int messageResId, int okButtonResId, int cancelButtonResId, int otherButtonResId) {
        synchronized (InputDialog.class) {
            InputDialog inputDialog = show(
                    context,
                    context.getString(titleResId),
