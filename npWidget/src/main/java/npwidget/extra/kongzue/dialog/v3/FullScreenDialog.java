...
import npwidget.extra.kongzue.dialog.util.view.ActivityScreenShotImageView;
import npwidget.extra.kongzue.dialog.util.view.BlurView;
import npwidget.extra.kongzue.dialog.util.view.InterceptYLinearLayout;
...
public class FullScreenDialog extends BaseDialog {
    ...
    public static FullScreenDialog build(@NonNull FragmentActivity context) {
    ...
    public static FullScreenDialog show(@NonNull FragmentActivity context, int layoutResId, OnBindView onBindView) {
